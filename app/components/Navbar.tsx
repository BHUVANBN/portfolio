  ...
  return (
    ...
    >
      <div className="max-w-7xl w-full px-6 flex gap-8">
        ...
        <div className="flex-1 flex items-center justify-between px-8 py-3 rounded-[32px] bg-[#0c0c0c]/80 backdrop-blur-2xl border border-[#1a1a1a] pointer-events-auto shadow-2xl">
          ...
          <div className="flex items-center gap-8 text-[11px] uppercase font-bold tracking-[0.25em] text-white/30">
